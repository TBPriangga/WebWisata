...
<html>
<head>
    <title>Tiket Pinus Lepakuwus</title>
    <meta charset="utf-8">
...
<body>
                                ...
                                <div class="product">
                                    <div class="row">
                                        <div class="col-md-4 img-card">
                                            <img class="img-fluid mx-auto d-block image" src="assets/img/pinus.jpg">
                                        </div>
                                        <div class="col-md-8">
                                            <div class="info">
                                                <div class="row">
                                                    <div class="col-md-5 product-name">
                                                        <div class="product-name">
                                                            <a href="#">Curug Hutan Pinus Lepakuwus</a>
    ...
    <script>
        ...
        $('#checkoutBtn').on('click', function() {
            ...
            var gardenName = 'Hutan Pinus'; // Store the garden name
