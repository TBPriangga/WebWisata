        ...
        <div class="navbar-default sidebar" role="navigation">
            <div class="sidebar-nav slimscrollsidebar">
                ...
                <ul class="nav" id="side-menu">
                    <li class="nav" style="padding: 70px 0 0;">
                ...
                <div class="center p-20">
                     <a href="logout.php" class="btn btn-danger btn-block waves-effect waves-light" style="margin-top:320px;">Logout</a>
                 </div>
            </div>
