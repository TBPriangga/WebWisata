...
<html>
<head>
    <title>Tiket Telaga Sunyi</title>
    <meta charset="utf-8">
...
<body>
                                ...
                                <div class="product">
                                    <div class="row">
                                        <div class="col-md-4 img-card">
                                            <img class="img-fluid mx-auto d-block image" src="assets/img/sunyi.jpg">
                                        </div>
                                        <div class="col-md-8">
                                            <div class="info">
                                                <div class="row">
    ...
    <script>
        ...
        $('#checkoutBtn').on('click', function() {
            ...
            var gardenName = 'Telaga Sunyi'; // Store the garden name
