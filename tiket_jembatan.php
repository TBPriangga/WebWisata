...
<html>
<head>
    <title>Tiket Jembatan Kaca  </title>
    <meta charset="utf-8">
...
<body>
                                ...
                                <div class="product">
                                    <div class="row">
                                        <div class="col-md-4 img-card">
                                            <img class="img-fluid mx-auto d-block image" src="assets/img/jembatan.jpg">
                                        </div>
                                        <div class="col-md-8">
                                            <div class="info">
                                                <div class="row">
                                                    <div class="col-md-5 product-name">
                                                        <div class="product-name">
                                                            <a href="#">Jembatan Kaca Baturaden</a>
                                                            <div class="product-info">
                                                                <div>Lokasi: <span class="value">Baturaden</span></div>
                                                                <div>harga Tiket: <span class="value">Rp 20.000</span></div>
                                                    ...
                                                    <div class="col-md-4 quantity">
                                                        ...
                                                        <input id="quantity" type="number" value="1" class="form-control quantity-input" data-price="20000">
                                                    </div>
                                                </div> 	
                                            </div>
                                        </div>
    ...
    <script>
        ...
        $('#checkoutBtn').on('click', function() {
            ...
            var gardenName = 'Jembatan Kaca Baturaden'; // Store the garden name
